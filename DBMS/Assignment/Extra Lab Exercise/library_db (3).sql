...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab3_if_else` (IN `p_book_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab3_members_cursor` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab3_variables` ()   BEGIN
    -- Declare variables
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab4_all_books` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab4_books_by_author` (IN `p_author` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `lab4_constants` ()   BEGIN
...
(7, 'Pride and Prejudice', 'Jane Austen', 'T. Egerton', '0000', 400.00, NULL, NULL, '2025-11-20 13:07:45'),
(8, '1984', 'George Orwell', 'Secker & Warburg', '1949', 500.00, NULL, NULL, '2025-11-20 13:07:45'),
